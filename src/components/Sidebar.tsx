  ...
  return (
    <Container>
      ...
      >
        ...
        <MenuLink to="https://github.com/mscbuild/todo-listapp">
        ...
        <MenuLink to="https://github.com/mscbuild/todo-listapp/issues/new">
          <StyledMenuItem>
        ...
        <MenuLink to="https://github.com/mscbuild">
        ...
        <ProfileOptionsBottom>
          ...
          <CreditsContainer translate="no">
            ...
            <a
              ...
              href="https://github.com/mscbuild"
            >
              mscbuild
            </a>
          </CreditsContainer>
